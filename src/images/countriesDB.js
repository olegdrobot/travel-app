const countriesArr = {
  Austria: {
      ...
      videoImage: require('../images/austria/austriaVideo.jpg'),
      showplaces: [
              {
  ...
  Croatia: {
      ...
      videoImage: require('../images/croatia/croatiaVideo.jpg'),
      showplaces: [
              {
  ...
  Czech: {
      ...
      videoImage: require('../images/czech/czechVideo.jpg'),
      showplaces: [
              {
  ...
  France: {
      ...
      videoImage: require('../images/france/franceVideo.jpg'),
      showplaces: [
              {
  ...
  Germany: {
      ...
      videoImage: require('../images/germany/germanyVideo.jpg'),
      showplaces: [
              {
  ...
  Italy: {
      ...
      videoImage: require('../images/italy/italyVideo.jpg'),
      showplaces: [
              {
  ...
  Poland: {
      ...
      videoImage: require('../images/poland/polandVideo.jpg'),
      showplaces: [
              {
  ...
  Slovakia: {
      ...
      videoImage: require('../images/slovakia/slovakiaVideo.jpg'),
      showplaces: [
              {
  ...
  Spain: {
      ...
      videoImage: require('../images/spain/spainVideo.jpg'),
      showplaces: [
              {
